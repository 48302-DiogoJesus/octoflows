...
## Workflow 1 (INVALID)
t1 = dummy_task(1)
t1.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="A"))

t2 = dummy_task(t1)
t2.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="B"))
t3 = dummy_task(t1)
t3.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="B"))

t4 = dummy_task(t2)
t4.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="C"))
t5 = dummy_task(t3, t4)
t5.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="B"))

t6 = dummy_task(t5)
t6.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="C"))
t7 = dummy_task(t5)
t7.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="C"))

wf1 = dummy_task(t6, t7)
wf1.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="C"))
...
# t4 = dummy_task(t2)
# t4.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="B"))
# t5 = dummy_task(t3)
# t5.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="B"))

# wf2 = dummy_task(t4, t5)
# wf2.add_annotation(DAGPlanner.TaskWorkerResourceConfiguration(cpus=1, memory_mb=1, worker_id="C"))
